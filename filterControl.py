...
class CustomFilterPanel(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        #***ADD***
        self.startDateCombo = wx.ComboBox(self, -1, choices=list(monthDict.keys()), default=defaultMonth, style=wx.CB_DROPDOWN|wx.CB_DROPDOWN)
        self.Bind(wx.EVT_COMBOBOX, self.OnMonthStart, self.startMonthControl)
        #***END ADD***
        
        self.startYearText = wx.StaticText(self, -1, "start year")
        self.startYearCombo = wx.ComboBox(self, -1, choices=[2010, 2011], default=now.year, style=wx.CB_DROPDOWN|wx.CB_DROPDOWN)
    ...
    def __do_layout(self):
        ...
        #***ADD***
        filterSizerRight.Add(self.slider, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL, 5)
        #***END ADD***
